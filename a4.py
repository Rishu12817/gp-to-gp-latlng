...
try:
    ...
    with open(csv_file_path, "r", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            administrative_area_level_2 = row.get('administrative_area_level_2', '')
            political = row.get('political', '')
            administrative_area_level_1 = row.get('administrative_area_level_1', '')
            country = row.get('country', '')
            postal_code = row.get('postal_code', '')
            street_number = row.get('street_number', '')
            route = row.get('route', '')
            sublocality = row.get('sublocality', '')
            sublocality_level_1 = row.get('sublocality_level_1', '')
            locality = row.get('locality', '')
            administrative_area_level_3 = row.get('administrative_area_level_3', '')
            premise = row.get('premise', '')
            postal_code_suffix = row.get('postal_code_suffix', '')
            establishment = row.get('establishment', '')
            point_of_interest = row.get('point_of_interest', '')
            neighborhood = row.get('neighborhood', '')
            park = row.get('park', '')
            transit_station = row.get('transit_station', '')
            landmark = row.get('landmark', '')
            subpremise = row.get('subpremise', '')
            sublocality_level_2 = row.get('sublocality_level_2', '')
            campground = row.get('campground', '')
            lodging = row.get('lodging', '')
            bus_station = row.get('bus_station', '')
            subway_station = row.get('subway_station', '')
            postal_code_prefix = row.get('postal_code_prefix', '')
            sublocality_level_3 = row.get('sublocality_level_3', '')
            airport = row.get('airport', '')
            sublocality_level_4 = row.get('sublocality_level_4', '')
            train_station = row.get('train_station', '')
            administrative_area_level_4 = row.get('administrative_area_level_4', '')
            administrative_area_level_5 = row.get('administrative_area_level_5', '')
            postal_town = row.get('postal_town', '')
            tourist_attraction = row.get('tourist_attraction', '')
            spa = row.get('spa', '')
            travel_agency = row.get('travel_agency', '')
            light_rail_station = row.get('light_rail_station', '')
            zoo = row.get('zoo', '')
            administrative_area_level_7 = row.get('administrative_area_level_7', '')
            administrative_area_level_6 = row.get('administrative_area_level_6', '')
            insurance_agency = row.get('insurance_agency', '')
            post_box = row.get('post_box', '')
            cafe = row.get('cafe', '')
            food = row.get('food', '')
            car_rental = row.get('car_rental', '')
            ...
            DO UPDATE SET
                ...
                Place_ID = '{place_id}', Place_Types = '{place_types}', plus_code = '{plus_code}',
                administrative_area_level_2 = '{administrative_area_level_2}', political = '{political}',
                administrative_area_level_1 = '{administrative_area_level_1}', country = '{country}',
                postal_code = '{postal_code}', street_number = '{street_number}', route = '{route}',
                sublocality = '{sublocality}', sublocality_level_1 = '{sublocality_level_1}', locality = '{locality}',
                administrative_area_level_3 = '{administrative_area_level_3}', premise = '{premise}', postal_code_suffix = '{postal_code_suffix}',
                establishment = '{establishment}', point_of_interest = '{point_of_interest}', neighborhood = '{neighborhood}',
                park = '{park}', transit_station = '{transit_station}', landmark = '{landmark}', subpremise = '{subpremise}',
                sublocality_level_2 = '{sublocality_level_2}', campground = '{campground}', lodging = '{lodging}',
                bus_station = '{bus_station}', subway_station = '{subway_station}', postal_code_prefix = '{postal_code_prefix}',
                sublocality_level_3 = '{sublocality_level_3}', airport = '{airport}', sublocality_level_4 = '{sublocality_level_4}',
                train_station = '{train_station}', administrative_area_level_4 = '{administrative_area_level_4}', administrative_area_level_5 = '{administrative_area_level_5}',
                postal_town = '{postal_town}', tourist_attraction = '{tourist_attraction}', spa = '{spa}',
                travel_agency = '{travel_agency}', light_rail_station = '{light_rail_station}', zoo = '{zoo}',
                administrative_area_level_7 = '{administrative_area_level_7}', administrative_area_level_6 = '{administrative_area_level_6}',
                insurance_agency = '{insurance_agency}', post_box = '{post_box}', cafe = '{cafe}', food = '{food}',
                car_rental = '{car_rental}', museum = '{museum}', store = '{store}';
            """
            print("\nExecuting Query:\n", insert_query)
